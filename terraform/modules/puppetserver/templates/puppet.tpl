...
runcmd:
  ...
  - sed -i '/\[main\]/a dns_alt_names=puppet.service.consul,puppetserver.service.consul,puppetmaster.service.consul,vault.service.consul' /etc/puppetlabs/puppet/puppet.conf
